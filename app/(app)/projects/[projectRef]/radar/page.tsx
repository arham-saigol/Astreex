...
function AddSubredditInput({
  ...
  const handleSubmit = async () => {
    ...
    onDone()
    try {
      const result = await addSubreddit({ projectRef, name })
      if (result) {
...
export default function RadarPage() {
  ...
  const subreddits = useQuery(api.subreddits.getSubreddits, { projectRef })
  const radarStatus = useQuery(api.subreddits.getRadarStatus, { projectRef })
